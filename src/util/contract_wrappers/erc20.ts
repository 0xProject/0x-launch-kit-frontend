...
export class erc20Contract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return erc20Contract.deployAsync(bytecode, abi, provider, txDefaults);
    }
    public static async deployAsync(
        ...
        const contractInstance = new erc20Contract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('erc20', erc20Contract.ABI(), address, supportedProvider, txDefaults);
