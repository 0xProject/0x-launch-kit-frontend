...
const figmaThemeInfoToThemeProperties = (figmaThemeInfo: FigmaThemeInfo): ThemeProperties => {
    const partialThemeProperties: Partial<ThemeProperties> = {
        ...
        modalSearchFieldBorderColor: figmaThemeInfo.primaryText.value,
        ...
        borderColor: figmaThemeInfo.supplementaryText.value,
        ethBoxBorderColor: figmaThemeInfo.supplementaryText.value,
        ethSliderThumbBorderColor: figmaThemeInfo.supplementaryText.value,
